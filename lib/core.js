...
module.exports = function(config) {
  ...
  function call(method, url, params, callback) {
    ...
    if (typeof config.proxy !== "undefined" && config.proxy !== null) options.proxy = config.proxy;
    if (typeof config.auth !== "undefined" && config.auth !== null ) options.auth = config.auth;
    if (typeof config.ca !== "undefined" && config.ca !== null ) options.ca = config.ca;
    if (typeof config.rejectUnauthorized !== "undefined" && config.rejectUnauthorized !== null ) options.rejectUnauthorized = config.rejectUnauthorized;
    if (typeof config.agent !== "undefined" && config.agent !== null ) options.agent = config.agent;
